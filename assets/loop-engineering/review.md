...
- Resolve CodeGraph with `node dist/cli/codegraphctl.js resolve --workspace <repo>`. Query an existing healthy index read-only; never synchronize or create an index from Review.
