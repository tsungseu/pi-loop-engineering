...
test("transaction admission rejects every Schema family that carries another loop_id", async (t) => {
  ...
  const fixtures: readonly [TransactionKind, unknown][] = [
    ...
    ["WAVE_INPUT", {
      ...
      repository_identity_digest: common,
    ...
    ["EVIDENCE", {
      ...
      output_tree_digest: common, argv: ["C:/tools/npm.exe", "test"], executable_path: "C:/tools/npm.exe",
      executable_digest: common, version_argv: ["C:/tools/npm.exe", "--version"], cwd: "C:/workspace",
      timeout_ms: 1000, stdout_limit_bytes: 1048576, stderr_limit_bytes: 1048576, started_at: timestamp,
      ended_at: timestamp, exit_code: 0, exit_signal: null, termination_path: "NATURAL_EXIT", environment_digest: common, tool_versions: { "C:/tools/npm.exe": "10.0.0" },
