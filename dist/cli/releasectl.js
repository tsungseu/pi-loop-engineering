...
import { checkReadiness, performReleaseAction, reconcileOperation, } from "../core/release.js";
...
async function loadAuthorization(path) {
    ...
    if (typeof raw.authorization_id !== "string"
...
async function run(parsed) {
    ...
    switch (command) {
        ...
        case "action": {
            ...
            if (options["release-id"] !== undefined)
                request.releaseId = options["release-id"];
...
//# sourceMappingURL=releasectl.js.map